...
def get_agent(data,llm):
    ...
    data_description = """
    Your role is to analyze the data and provide insights to the user.
    The data consists of stock information of different medicines in different hospitals according to date and year. 
    The hospitals are also classified according to province and district.
    Some of the important columns you show know about are:

    DispenseQty - Quantity of a product dispensed in a month
    ClosingStock - Closing stock of a product in a month
    AMC - Average Monthly Consumption of a product
